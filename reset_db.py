...
def reset_database_auto():
    """
    Resetea automáticamente la base de datos sin interacción del usuario.
    Crea una estructura completamente nueva con datos de ejemplo.
    """
...
if __name__ == "__main__":
    # Si se pasa el argumento --auto, resetear automáticamente
